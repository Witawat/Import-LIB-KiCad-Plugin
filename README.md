...
![GitHub Release](https://img.shields.io/github/v/release/Witawat/Import-LIB-KiCad-Plugin?logo=github)
![GitHub Downloads](https://img.shields.io/github/downloads/Witawat/Import-LIB-KiCad-Plugin/total)
![License](https://img.shields.io/github/license/Witawat/Import-LIB-KiCad-Plugin)
...
1. ดาวน์โหลดไฟล์ `Import-LIB-KiCad-Plugin.zip` ล่าสุดจาก [GitHub Releases](https://github.com/Witawat/Import-LIB-KiCad-Plugin/releases/latest)
...
git clone --recurse-submodules https://github.com/Witawat/Import-LIB-KiCad-Plugin.git
...
- [Steffen Wittemeier (Steffen-W)](https://github.com/Steffen-W) — ผู้สร้างโครงการต้นฉบับ
...
- [kiutils](https://github.com/Steffen-W/kiutils) — KiCad library file parser
- ผู้ร่วมพัฒนาและ tester ทุกท่านที่ช่วยแก้ไขข้อบกพร่อง

---

<p align="center">
  <a href="https://github.com/Witawat/Import-LIB-KiCad-Plugin/issues/new">
