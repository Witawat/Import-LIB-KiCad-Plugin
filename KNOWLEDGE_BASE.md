...
## เคล็ดลับการ debug
1. log file หลัก: `plugins/plugin.log`
2. fallback log: `plugins/plugin_fallback.log`
3. เปิด debug mode: ตั้ง logger level DEBUG
4. ทดสอบแบบ standalone: `python -c "from plugins.impart_action import ImpartFrontend; import wx; app=wx.App(); f=ImpartFrontend(); f.ShowModal()"`
5. ทดสอบ CLI import: `python -m plugins.KiCadImport --download-file test.zip --lib-folder output/`
